  ...
  <div class="max-w-md w-full glass rounded-3xl p-10 text-center relative z-10 border-red-500/20">
    ...
    <div class="space-y-4">
      ...
      <div class="pt-4 border-t border-white/5 mt-6">
        ...
        <a href="https://wa.me/+233546666519" target="_blank" class="inline-flex items-center gap-2 text-olive-400 hover:text-olive-300 font-semibold transition-colors">
